...
namespace Constants {// 使用时要加命名空间
    ...
    constexpr int   melonseed1 = 15;
    constexpr int   tomatoseed1 = 25;
    constexpr int   blueburryseed1 = 10;
    constexpr int  chilipepperseed1 = 20;
    constexpr int   wheatseed1 = 30;
    constexpr int   turnipseed1 = 30;
    constexpr int   poppiesseed1 = 10;
    constexpr int   summersequinsseed1 = 10;
    constexpr int   hopseed1 = 40;
    constexpr int        cornseed1 = 20;
    constexpr int    sunflowerseed1 = 30;
    constexpr int  redleafcabbageseed1 = 15;
